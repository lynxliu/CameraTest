...
{
    public partial class ISO12233ExTest : UserControl, IChartTestWindow
    {
        ...
        public ISO12233ExTest()
        {
            ...
            ci = new CameraTestIcon(this,null,"ISO12233Ex","增强型ISO12233测试卡");
        ...
        void TestHMTF()
        {
            ...
            {
                BeginTime = DateTime.Now;
                double r = (testHelper.CurrentChart as ISO12233ExChart).getHEdgeResoveLines();
        ...
        void TestVMTF()
        {
            ...
            {
                BeginTime = DateTime.Now;
                double r = (testHelper.CurrentChart as ISO12233ExChart).getVEdgeResoveLines();
            ...
            {
                testHelper.ProcessError(xe, "中央分辨率（垂直线）测试错误");
            }
        }
        ...
        void TestHDispersiveness()
        {
            ...
            {
                BeginTime = DateTime.Now;
                decimal d = (testHelper.CurrentChart as ISO12233ExChart).getHDispersiveness();
                ...
                EndTime = DateTime.Now;
                LParameter lp = testHelper.getNewParameter("ISO2233Ex测试卡", Convert.ToDouble(d), BeginTime, EndTime);
                lp.Name = "色散（水平线）";
        ...
        void TestVDispersiveness()
        {
            ...
            {
                BeginTime = DateTime.Now;
                decimal d = (testHelper.CurrentChart as ISO12233ExChart).getVDispersiveness();
