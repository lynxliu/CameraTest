...
{
    public partial class BadPixTest : UserControl
    {
        public BadPixTest()
        {
            InitializeComponent();
        ...
        void ShowGBBadInfor()
        {
            ...
            {
                if (p.XPosition > lChartPhotoBadPix.getPhoto().PixelWidth * 0.25 && p.XPosition < lChartPhotoBadPix.getPhoto().PixelWidth * 0.75 && p.YPosition > lChartPhotoBadPix.getPhoto().PixelHeight * 0.25 && p.YPosition < lChartPhotoBadPix.getPhoto().PixelHeight * 0.75)
                {
                    c++;
                }
            }
        ...
        {
            lChartPhotoBadPix.setPhoto(b);
            lChartPhotoBadPix.getImage().Opacity = 0.5;
        }
