...
{
    public sealed partial class LynxShowChartView : UserControl
    {
        public LynxShowChartView()
        {
        ...
        {
            Photo.Source = new BitmapImage(new Uri("ms-appx://////PhotoEditControl//Images/" + name + "jpg"));
        }
