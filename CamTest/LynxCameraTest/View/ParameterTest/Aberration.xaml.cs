...
{
    public partial class Aberration : UserControl, IParameterTestView
    {
        public Aberration()
        {
            InitializeComponent();
        ...
        public void Test(List<WriteableBitmap> bl)
        {
            if (bl == null||bl.Count==0) { return; }
            LChartPhoto.Photo = (bl.FirstOrDefault());
            TestImage();
        }
        ...
        private void buttonVLSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            im.PointerPressed += (ProcPhoto_MouseLeftButtonDown);
        }
        Line selectLine = new Line();
        void ProcPhoto_MouseLeftButtonDown(object sender, PointerRoutedEventArgs e)
        {
            Image im = LChartPhoto.getImage();
            im.PointerPressed -= (ProcPhoto_MouseLeftButtonDown);
            if (LChartPhoto.Photo == null) { return; }
        ...
        public void InitViewModel()
        {
            ...
            if (vm == null) return;
            vm.Title = "Aberration Parameter";
            vm.TestAction = TestImage;
        }
    }
}
