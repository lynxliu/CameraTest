...
{
    public partial class RayleiResolution : UserControl, IParameterTestView
    {
        ...
        private void imageSetLeft_MouseLeftButtonDown(object sender, PointerRoutedEventArgs e)
        {
            lChartPhoto1.getDrawObjectCanvas().PointerMoved -= (image_MouseMove);
            lChartPhoto1.getDrawObjectCanvas().PointerPressed -= (imageSetLeft_MouseLeftButtonDown);
        ...
        private void imageSetRight_MouseLeftButtonDown(object sender, PointerRoutedEventArgs e)
        {
            lChartPhoto1.getDrawObjectCanvas().PointerMoved -= (image_MouseMove);
            lChartPhoto1.getDrawObjectCanvas().PointerPressed -= (imageSetRight_MouseLeftButtonDown);
        ...
        {
            Test(new List<WriteableBitmap>(){sb});
        }
        ...
        void image_MouseMove(object sender, PointerRoutedEventArgs e)
        {
            if (!lChartPhoto1.getDrawObjectCanvas().Children.Contains(Selectl))
            {
                lChartPhoto1.getDrawObjectCanvas().Children.Add(Selectl);
        ...
        public void InitViewModel()
        {
            ...
            if (vm == null) return;
            vm.Title = "Raylei Resolution Parameter";
